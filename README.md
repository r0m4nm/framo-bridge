...
### 2. Install Dependencies (Required for Fast Decimation)

The addon requires Python packages for optimal performance:
- **trimesh** - Fast mesh decimation and repair
- **scipy** - Scientific computing backend
- **fast-simplification** - Performance optimization
...
**Note:** Without dependencies, addon still works but uses slower BMESH decimation (10-50x slower).

See [.guides/DEPENDENCIES.md](.guides/DEPENDENCIES.md) for detailed installation help.
